package com.lomboktech.mangaapp;
...
import com.lomboktech.mangaapp.adapter.AdapterChapter;
import com.lomboktech.mangaapp.api.ApiEndpoint;
import com.lomboktech.mangaapp.model.ModelChapter;
import com.lomboktech.mangaapp.model.ModelKomik;
...
public class DetailPopulerActivity extends AppCompatActivity implements AdapterChapter.onSelectData{

    Toolbar toolbar;
    TextView tvTitle, tvName, tvType, tvStatus, tvNameAuthor, tvAllChapter, tvSynopsis;
    ImageView imgCover, imgPhoto;
    String Endpoint, Cover, Thumb, Title, Type, Status, NameAuthor, AllChapter, Synopsis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        modelKomik = (ModelKomik) getIntent().getSerializableExtra("detailKomik");
        if (modelKomik != null) {

            Endpoint = modelKomik.getEndpoint();
            Title = modelKomik.getTitle();
            Cover = modelKomik.getThumb();
            AllChapter = modelKomik.getChapter();
            ...
            tvAllChapter.setText(AllChapter);
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(DetailPopulerActivity.this,
                    ...
                    public void onError(ANError anError) {
                        progressDialog.dismiss();
                        Toast.makeText(DetailPopulerActivity.this, "Tidak ada jaringan internet!",
    ...
    private void showAllChapter() {
        adapterChapter = new AdapterChapter(DetailPopulerActivity.this, modelChapter, this);
        rvChapter.setAdapter(adapterChapter);
    }

    @Override
    public void onSelected(ModelChapter modelChapter) {
        Intent intent = new Intent(DetailPopulerActivity.this, ChapterActivity.class);
